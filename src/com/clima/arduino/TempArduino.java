...
public class TempArduino extends javax.swing.JFrame {

    public TempArduino() {
        initComponents();

        ArduinoSerial ArduinoTemp = new ArduinoSerial("COM4"); //"COM.." é a porta Arduino.
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                ArduinoTemp.initialize();

                while (true) {
                    //Testando ArduinoTemp atual
                    lbTemperatura.setText(ArduinoTemp.read());

                    //Comando Sql a seguir
                    if (ArduinoTemp.read() != null && Double.parseDouble(ArduinoTemp.read()) > 20.00) {
                        ...
                        try {
                            ...
                            temp.setTempAtual(Double.parseDouble(ArduinoTemp.read()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TempArduino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new TempArduino().setVisible(true);
        });
    }
    ...
    public static javax.swing.JLabel jblValorMaxima;
    public static javax.swing.JLabel jblValorMinima;
    public static javax.swing.JLabel lbTemperatura;
